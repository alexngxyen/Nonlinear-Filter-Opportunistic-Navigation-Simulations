#  ============================================================================
#  Name        : CDKF_Simulation.py
#  Description : Two-dimensional (2-D) central difference Kalman filter (CDKF) 
...
from Functions import Central_Difference_Kalman_Filter
import timeit
import numpy as np
...
h = np.sqrt(3)                                                                                # Spread of Sigma Points
...
# Construct Central Difference Kalman Filter State Vector
P_est = P
...
print("CDKF elapsed time =", '%.4f' % (end - start), "seconds")
...
print("where h = {} (spread of sigma points parameter)".format(h))
print("\n")
